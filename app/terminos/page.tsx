// Página de Términos y Condiciones de Unimotor
      ...
      <div style={{paddingTop: '104px', maxWidth: '800px', margin: '0 auto', padding: '120px 40px 80px'}}>
        ...
        <div style={{display: 'flex', flexDirection: 'column', gap: '32px'}}>
          ...
          {[
            {
              ...
              contenido: 'Al registrarte y usar Unimotor, aceptas estos Términos y Condiciones en su totalidad. Si no estás de acuerdo con alguna parte, no debes usar la plataforma. Unimotor se reserva el derecho de modificar estos términos en cualquier momento, notificando a los usuarios registrados.',
            },
            {
              titulo: '2. Descripción del servicio',
              contenido: 'Unimotor es un marketplace verificado de compra y venta de autos, repuestos y servicios automotrices en Chile. Actuamos como intermediario entre compradores y vendedores, facilitando el contacto entre ambas partes. Unimotor no es parte de ninguna transacción entre usuarios.',
            },
            {
            ...
            {
              titulo: '7. Responsabilidad de Unimotor',
              contenido: 'Unimotor facilita el contacto entre usuarios pero no garantiza la calidad, seguridad o legalidad de los vehículos publicados. No somos responsables de las transacciones realizadas fuera de la plataforma. Recomendamos siempre verificar el estado del vehículo con un mecánico de confianza antes de concretar cualquier compra.',
            },
            {
              titulo: '8. Privacidad y datos personales',
              contenido: 'Tus datos personales son tratados con confidencialidad y no son vendidos a terceros. La información de RUT y cédula es utilizada únicamente para verificación de identidad. Al registrarte aceptas que Unimotor pueda contactarte con información relevante sobre tu cuenta y publicaciones.',
            },
            {
              titulo: '9. Suspensión de cuentas',
              contenido: 'Unimotor puede suspender o eliminar cuentas que violen estos términos, realicen actividades fraudulentas, reciban múltiples reportes negativos de otros usuarios, o proporcionen información falsa durante el registro o verificación.',
            },
            {
              titulo: '10. Ley aplicable',
              contenido: 'Estos términos se rigen por las leyes de la República de Chile. Cualquier disputa será sometida a los tribunales competentes de Santiago de Chile. Al usar Unimotor confirmas que tienes al menos 18 años de edad.',
            },
          ].map((seccion) => (
          ...
          <div style={{background: '#eff6ff', borderRadius: '16px', padding: '28px 32px', border: '1px solid #bfdbfe'}}>
            ...
            <p style={{fontSize: '14px', color: '#666', lineHeight: 1.8}}>
              Si tienes preguntas sobre estos términos o sobre el funcionamiento de Unimotor, puedes contactarnos a través del formulario de contacto o directamente al correo <strong>contacto@vericar.cl</strong>
            </p>
          </div>
