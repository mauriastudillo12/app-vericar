...
export default function Repuestos() {
  ...
  const limpiarFiltros = () => {
    setCategoria(''); setRegion(''); setComuna('')
    setEstado(''); setGarantia(false); setBusqueda('')
  }
  ...
  const panelFiltros = (
    <div style={{padding: '24px 20px'}}>
      ...
      <button onClick={() => { cargarRepuestos(); setFiltrosAbiertos(false) }} style={{
  ...
  return (
    <main style={{minHeight: '100vh', background: '#f5f5f5'}}>
      ...
      <style>{`
        ...
        .rep-grid { grid-template-columns: repeat(3, 1fr) !important; }
        ...
        @media (max-width: 768px) {
          ...
          .rep-content { padding: 16px !important; }
      ...
      <div style={{paddingTop: '104px'}}>
        ...
        <div style={{display: 'flex'}}>
          ...
          {/* Contenido principal */}
          <div className="rep-content" style={{flex: 1, padding: '24px 32px'}}>
            ...
            <div style={{display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '20px'}}>
              ...
              <div style={{display: 'flex', gap: '8px', alignItems: 'center'}}>
                <button
                  ...
                  style={{display: 'none', background: '#fff', border: '1.5px solid #e5e5e5', color: '#333', padding: '8px 16px', borderRadius: '8px', fontSize: '13px', fontWeight: '600', cursor: 'pointer', alignItems: 'center', gap: '6px'}}
                >
                  ⚙️ Filtros
                </button>
            ...
            {cargando ? (
              ...
              <div className="rep-grid" style={{display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '20px'}}>
                {repuestos.map((rep) => (
                  <Link key={rep.id} href={`/repuestos/${rep.id}`} style={{textDecoration: 'none'}}>
                    <div className="rep-card" style={{background: '#fff', borderRadius: '16px', overflow: 'hidden', border: '1px solid #eee', cursor: 'pointer'}}>
                      ...
                      <div style={{padding: '16px 18px'}}>
                        <div style={{display: 'inline-block', background: '#eff6ff', color: '#2563eb', fontSize: '10px', fontWeight: '700', padding: '3px 8px', borderRadius: '4px', marginBottom: '8px'}}>
                          {rep.categoria}
                        </div>
