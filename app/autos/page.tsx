...
function AutosContent() {
  ...
  // Estados para los autos y carga
  ...
  // Leer sesión y parámetro q de la URL al cargar
  useEffect(() => {
  ...
  // Cargar autos desde Supabase con filtros
  ...
  return (
    <main style={{minHeight: '100vh', background: '#f5f5f5'}}>
      ...
      <style>{`
        ...
        .btn-buscar-main:hover { background: #1d4ed8 !important; transform: scale(1.02); }
        .btn-aplicar { transition: background 0.2s, transform 0.15s; }
      ...
      <div style={{paddingTop: '104px'}}>
        ...
        <div style={{display: 'flex'}}>
          ...
          <div style={{
            ...
            padding: '24px 20px', minHeight: 'calc(100vh - 104px)',
          }}>
            ...
            <button className="btn-aplicar" onClick={() => cargarAutos()} style={{
                  ...
                  <Link key={auto.id} href={`/autos/${auto.id}`} style={{textDecoration: 'none'}}>
                    <div className="car-card" style={{background: '#fff', borderRadius: '16px', overflow: 'hidden', border: '1px solid #eee', cursor: 'pointer'}}>
                      ...
                      <div style={{padding: '16px 18px'}}>
                        ...
                        {/* Footer: región y botón contactar */}
                        <div style={{display: 'flex', alignItems: 'center', justifyContent: 'space-between', paddingTop: '12px', borderTop: '1px solid #f0f0f0'}}>
                          ...
                          {/* Botón contactar — redirige al chat si hay sesión */}
                          <button
